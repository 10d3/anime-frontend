...
import { Bookmark, Calendar, CalendarIcon, Grid2X2, HomeIcon, LogIn, MailIcon, PencilIcon, Search } from "lucide-react";
...
const DATA = {
  navbar: [
    ...
    { href: "/blog", icon: Grid2X2, label: "Category" },
...
export default function Navbar() {
  return (
    <nav className="absolute bottom-4 flex h-auto w-full flex-col items-center justify-center overflow-hidden">
